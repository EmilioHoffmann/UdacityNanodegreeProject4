...
class GeofenceTransitionsJobIntentService : JobIntentService(), CoroutineScope {
    ...
    override fun onHandleWork(intent: Intent) {
        ...
        if (geofenceEvent.geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER && geofenceEvent.triggeringGeofences.isNotEmpty()) {
            sendNotification(geofenceEvent.triggeringGeofences)
        }
    }

    private fun sendNotification(triggeredGeofenceList: List<Geofence>) {
        for (trigger in triggeredGeofenceList) {
